...
export const projects = [
  {
    ...
    technologies: ['Python', 'FastAPI', 'OpenRouter API', 'Jinja2', 'Uvicorn'],
    live_url: 'https://github.com/alfaarizi/agentic-quiz-generator',
  ...
  },
  {
    ...
    technologies: ['Python', 'FastAPI', 'React', 'TypeScript', 'D3.js', 'MongoDB', 'WebSocket'],
  ...
  },
  {
    ...
    description: 'Multi-agent system with ChromaDB',
    long_description:
    ...
    technologies: ['LangGraph', 'LangChain', 'ChromaDB', 'FastAPI', 'React', 'TypeScript'],
    live_url: 'https://github.com/alfaarizi/agentic-writing-assistant',
  ...
  },
  {
    ...
    technologies: ['C#', '.NET', 'Godot', 'GitLab CI/CD', 'A* pathfinding'],
    live_url: 'https://github.com/alfaarizi/godot-mono-core',
